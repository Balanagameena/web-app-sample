var zodiacs = [
    {
        name: "Aries",
        image: "client/Images/aries.jpg",
        month: "March 23 - April 10",
    ...
    {
        name: "Taurus",
        image: "client/Images/taurus.jpg",
    ...
    {
        name: "Gemini",
        image: "client/Images/gemini.jpg",
    ...
    {
        name: "Cancer",
        image: "client/Images/cancer.jpg",
    ...
    {
        name: "Scorpio",
        image: "client/Images/scorpio.jpg",
    ...
    {
        name: "Sagittarius",
        images: ".client/Images/sagittarius.jpg",
        month: "November 22 - December 22",
    ...
    {
        name: "Capricon",
        image: "client/Images/capricon.jpg",
    ...
    {
        name: "Aquarius",
        image: "client/Images/aquarius.jpg",
    ...
    {
        name: "Pisces",
        image: "client/Images/pisces.jpg",
...
function getData(){
    ...
    for ( var i = 0; i<zodiacs.length;i++){
        if (usersearch === zodiacs[i].name.toLowerCase()){
            ...
            document.getElementById('month').innerHTML = zodiacs[i].month;
